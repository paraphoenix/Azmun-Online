                ...
                <?php 
                    ...
                    if ($result->num_rows > 0) {
                        while ($exam =  $result->fetch_array()) {
                            ...
                            $start_time = $exam[5];
                            $finish_time = $exam[6];
                            echo "<a href='https://hamedesmaili.com/user/exam/register_exam.php?e_id=$exam_id' class='btn btn-dark'><h2>" . $exam_name . "</h2><h6> برای شرکت در آزمون کلیک کنید </h6></a>" . "</div>";  
                        }
                    } else {
